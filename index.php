	...
	<div class="container"> <?= $message ?> <h1>Création de personnage</h1>
		<form method="post" action="ajouter_personnage.php">
			...
			<select id="race" name="race" required>
				...
				<option value="harien">Harien</option>
			...
			<input type="number" id="force_" name="force_" min="1" max="100" value="10" required><br>
			<label for="dexterite">Dextérité :</label>
			<input type="number" id="dexterite" name="dexterite" min="1" max="100" value="10" required><br>
			<label for="constitution">Constitution :</label>
			<input type="number" id="constitution" name="constitution" min="1" max="100" value="10" required><br>
			<label for="intelligence">Intelligence :</label>
			<input type="number" id="intelligence" name="intelligence" min="1" max="100" value="10" required><br>
			<label for="sagesse">Sagesse :</label>
			<input type="number" id="sagesse" name="sagesse" min="1" max="100" value="10" required><br>
			<label for="charisme">Charisme :</label>
			<input type="number" id="charisme" name="charisme" min="1" max="100" value="10" required><br>
